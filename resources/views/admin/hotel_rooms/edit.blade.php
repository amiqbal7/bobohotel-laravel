                ...
                <form method="POST" action="{{ route('admin.hotel_rooms.update', $hotelRoom) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                            value="{{ $hotelRoom->name }}" autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full" type="number" name="price"
                            value="{{ $hotelRoom->price }}" autofocus autocomplete="price" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="total_people" class="block mt-1 w-full" type="number" name="total_people"
                            value="{{ $hotelRoom->total_people }}" autofocus autocomplete="total_people" />
